...
(ns epicerie.semaines.semaine-2-4
  (:use epicerie.core))
...
(def mar-souper-2-4
     (list
      (get-recipe "Saumon en croute de sesame" 2)
      (make-recipe 1
		   (list
		    (make-ingredient "couscous ble entier" (cup (* 2 1/2)))
