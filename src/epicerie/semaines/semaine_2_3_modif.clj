...
(ns epicerie.semaines.semaine-2-3-modif
  (:use epicerie.core))
...
(def mar-diner-2-3
     (list
      (make-recipe 1
		   (list
		    (make-ingredient "Soupe a la courge musquee, au cari et aux pommes" 1)
...
(def mar-souper-2-3
      (get-recipe "Quiche sans croute jambon et asperges" 1))
